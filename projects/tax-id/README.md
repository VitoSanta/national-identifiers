...
Guernsey, Hong Kong, Jersey, Puerto Rico and Taiwan are exposed separately through
...
format/checksum validation is available for 38 countries and company/entity
tax validation for 12. Use `SUPPORTED_VAT_COUNTRIES` and
`SUPPORTED_COMPANY_TAX_COUNTRIES` to discover the exact sets at runtime.
